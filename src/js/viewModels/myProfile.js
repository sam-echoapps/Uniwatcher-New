    ...
    function (oj,ko,$, app, ArrayDataProvider) {
        ...
        class StudentProfile {
            constructor(args) {
                ...
                self.studentId = ko.observable(sessionStorage.getItem("userStudentId"));
                const studentId = sessionStorage.getItem("userStudentId")
                ...
                self.createTrainObservableArray = function (trainName) {
                    return [
                        ...
                        { label: 'My Credentials', id: '3' + '-' + trainName },
                    ];
                };       
