    ...
    function (oj,ko,$, app, ArrayDataProvider, ojconverterutils_i18n_1) {
        ...
        class FinalChoiceReport {
            constructor(args) {
                ...
                self.viewProfile = (e)=>{
                    // window.location.href = `/?ojr=franchiseStudentProfile&id=${e.currentTarget.id}`;
                ...
                self.showData = ()=>{
                    ...
                    if(radio=="CSD"){
                        $.ajax({
                            url: BaseURL+"/getFranchiseCounsellorFinalChoiceCSDReport",
                            type: 'POST',
                            data: JSON.stringify({
                                fromDate: fromDate,
                                toDate: toDate,
                        ...
                        self.asdData([])
                        $.ajax({
                            url: BaseURL+"/getFranchiseCounsellorFinalChoiceASDReport",
                            type: 'POST',
                            data: JSON.stringify({
                                fromDate: fromDate,
                                toDate: toDate,
